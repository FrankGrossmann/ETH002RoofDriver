...
{
    //
    // Your driver's DeviceID is ASCOM.ETH002.Dome
    //
    // The Guid attribute sets the CLSID for ASCOM.ETH002.Dome
    // The ClassInterface/None addribute prevents an empty interface called
    // _ETH002 from being created and used as the [default] interface
    //
    ...
    /// ASCOM Dome Driver for ETH002.
    /// </summary>
    [Guid("dd745ef9-59d5-4a42-b159-d6983d83eae3")]
    ...
    public class Dome : IDomeV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.ETH002.Dome";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Dome Driver for ETH002.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ETH002"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Dome()
        {
            tl = new TraceLogger("", "ETH002");
        ...
        private void SendPulse()
        {
            ...
            using (TcpClient client = new TcpClient(settings.IpOrHostname, (int)settings.TcpPort))
            {
                var stream = client.GetStream();
                string command = $":DOA,{(int)settings.Relais},{(byte)(settings.PulseTimeInSeconds * 10)}";

                if (!string.IsNullOrWhiteSpace(settings.TcpPassword))
                {
                    command = string.Concat(command, ",", settings.TcpPassword);
                }
